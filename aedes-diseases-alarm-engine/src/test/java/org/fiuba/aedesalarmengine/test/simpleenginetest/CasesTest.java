...
public class CasesTest {
	...
	private List<SymptomsScoringConfiguration> getDefaultSymptomsScoring(){
		...
		SymptomsScoringConfiguration symptomConfig8 = new SymptomsScoringConfiguration(new BooleanSymptom(8l, "HEMORRAGIAS"), symptomConfig8Valuations);
		...
		SymptomsScoringConfiguration symptomConfig9 = new SymptomsScoringConfiguration(new BooleanSymptom(9l, "SHOCK"), symptomConfig9Valuations);
		...
		SymptomsScoringConfiguration symptomConfig10 = new SymptomsScoringConfiguration(new BooleanSymptom(10l, "ICTERICIA"), symptomConfig10Valuations);
		...
		SymptomsScoringConfiguration symptomConfig11 = new SymptomsScoringConfiguration(new BooleanSymptom(11l,"LEUCOPENIA"), symptomConfig11Valuations);
		...
		SymptomsScoringConfiguration symptomConfig12 = new SymptomsScoringConfiguration(new BooleanSymptom(12l, "NEUTROPENIA"), symptomConfig12Valuations);
		...
		SymptomsScoringConfiguration symptomConfig13 = new SymptomsScoringConfiguration(new BooleanSymptom(13l, "LINFOPEMIA"), symptomConfig13Valuations);
		...
		SymptomsScoringConfiguration symptomConfig14 = new SymptomsScoringConfiguration(new BooleanSymptom(14l, "TROMBOCIPENIA"), symptomConfig14Valuations);
		...
		SymptomsScoringConfiguration symptomConfig15 = new SymptomsScoringConfiguration(new ValuatedSymptom(15l, "DURACION ENFERMEDAD", 0, 4, 1)  , symptomConfig15Valuations);
